...
import { requestUploadLink, setupTokenAvatar, uploadToIpfs } from "@/utils/avatar-api";
    ...
    if (distributor) {
      ...
      if (token!.avatarFile && tokenAddress) {
        try {
          ...
          await setupTokenAvatar(tokenAddress, cid, signature, walletClient.chain.id);
        } catch (e) {
          alert("Avatar upload failed — you can set it later from the token page.");
        }
      }
